...
/// Инициализация функции ReducerMinTest()
...
// инициализация функции сравения циклов for и cilk_for
...
int main()
{
	...
	// функции нахождения максимального и
	// минимального значений до сортировки
	...
	// вызов функции CompareForAndCilk_For()
